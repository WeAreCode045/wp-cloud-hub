...
export default function ProjectDetail() {
  ...
  const { data: team } = useQuery({
    ...
    queryFn: () => base44.entities.Team.get(project.team_id),
    enabled: !!project?.team_id,
  });

  const { data: site } = useQuery({
    queryKey: ['project-site', project?.site_id],
    queryFn: () => base44.entities.Site.get(project.site_id),
    ...
    <div className="p-6 md:p-8">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          {/* This button is kept as is, as per the outline's structure, not restricted by canManage */}
