...
export default function PluginDetail() {
  ...
  // const [uploadingNewVersion, setUploadingNewVersion] = useState(false); // Removed, not used
  // const [newVersionFile, setNewVersionFile] = useState(null); // Removed, not used
  ...
  const uninstallPluginMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ['all-sites'] }); // Invalidate all-sites list
  ...
  const installedCount = mySites.filter(site => {
  ...
  // Filter sites to show only those where the plugin is installed (new definition for the card)
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-500 mt-1">{plugin.description || "Geen beschrijving"}</p>
          </div>
        ...
        <div className="grid lg:grid-cols-2 gap-6">
              ...
              <CardHeader className="border-b border-gray-100">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex gap-2">
                    ...
                    {/* The primary "Versie Toevoegen" button is now in the header */}
                  </div>
                </div>
              </CardHeader>
          ...
          {/* Sites Section - Show only sites where plugin is installed */}
          <Card className="border-none shadow-lg">
            <CardHeader className="border-b border-gray-100">
              <CardTitle className="flex items-center gap-2">
            ...
            <CardContent className="p-6">
              {sitesPluginInstalledOnAnySite.length === 0 ? (
                <div className="text-center py-8 text-gray-500">
                  ...
                  <p>Deze plugin is nog niet geïnstalleerd op sites</p>
                </div>
              ) : (
